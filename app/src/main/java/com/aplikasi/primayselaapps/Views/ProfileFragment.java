...
public class ProfileFragment extends Fragment implements OnMapReadyCallback {
    ...
    @BindView(R.id.imgProfileEmail)
    ImageView imgProfileEmail;
...
//        }
    ...
    public void klik2(){
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setData(Uri.parse("https://www.instagram.com/lalaaprim/"));
        startActivity(intent);
    }
    @OnClick(R.id.imgProfileWhatsapp)
    public void klik3(){
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setData(Uri.parse("https://web.whatsapp.com/send?phone=+6282321039230"));
        startActivity(intent);
    }
    @OnClick(R.id.txtProfileAbout)
    public void klik4(){
        CustomDialog customDialog=new CustomDialog();
        customDialog.showDialog(getActivity(),"PrimayselaApps was developed by Primaysela Dwisepti Tuilan\n AKB 13-10116577");
    }
